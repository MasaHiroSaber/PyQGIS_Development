...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox = QtWidgets.QGroupBox(self.prev_tools_add)
        ...
        self.button_feature_editor = QtWidgets.QToolButton(self.groupBox)
        font = QtGui.QFont()
        font.setFamily("MiSans")
        font.setPointSize(8)
        font.setBold(False)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icon/icon/edit.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_feature_editor.setIcon(icon2)
        ...
        self.button_feature_select = QtWidgets.QToolButton(self.groupBox)
        font = QtGui.QFont()
        font.setFamily("MiSans")
        font.setPointSize(8)
        font.setBold(False)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icon/icon/operation.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_feature_select.setIcon(icon3)
        ...
        self.button_delete_feature_select = QtWidgets.QToolButton(self.groupBox)
        font = QtGui.QFont()
        font.setFamily("MiSans")
        font.setPointSize(8)
        font.setBold(False)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icon/icon/file-delete.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_delete_feature_select.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icon/icon/trash_light.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_prev_clear.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icon/icon/remove_light.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_prev_remove.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icon/icon/move.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_move.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icon/icon/zoomOut.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icon/icon/zoomIn.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icon/icon/refresh.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_refresh.setIcon(icon10)
        ...
        self.tab_tools_2 = QtWidgets.QWidget()
        self.tab_tools_2.setObjectName("tab_tools_2")
        self.tabWidget.addTab(self.tab_tools_2, "")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_tools_1), _translate("MainWindow", "功能1"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_tools_2), _translate("MainWindow", "功能2"))
import rc_rc
