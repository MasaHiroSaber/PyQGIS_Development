...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.button_city_tool = QtWidgets.QToolButton(self.groupBox_custom_tools)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icon/icon/map.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_city_tool.setIcon(icon2)
        self.button_city_tool.setIconSize(QtCore.QSize(25, 25))
        self.button_city_tool.setToolButtonStyle(QtCore.Qt.ToolButtonTextUnderIcon)
        self.button_city_tool.setAutoRaise(True)
        self.button_city_tool.setObjectName("button_city_tool")
        self.horizontalLayout_11.addWidget(self.button_city_tool, 0, QtCore.Qt.AlignBottom)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_city_tool.setText(_translate("MainWindow", "城市......"))
