...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.button_city_tool_2 = QtWidgets.QToolButton(self.groupBox_custom_tools)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icon/icon/contour.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_city_tool_2.setIcon(icon3)
        self.button_city_tool_2.setIconSize(QtCore.QSize(25, 25))
        self.button_city_tool_2.setToolButtonStyle(QtCore.Qt.ToolButtonTextUnderIcon)
        self.button_city_tool_2.setAutoRaise(True)
        self.button_city_tool_2.setObjectName("button_city_tool_2")
        self.horizontalLayout_11.addWidget(self.button_city_tool_2, 0, QtCore.Qt.AlignBottom)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_city_tool_2.setText(_translate("MainWindow", "城市....."))
